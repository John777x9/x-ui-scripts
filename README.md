...
```sh
bash <(curl -sSL https://raw.githubusercontent.com/John777x9/x-ui-scripts/refs/heads/main/build_3x-ui.sh)
```

## Install [Warp](https://gitlab.com/fscarmen/warp) (on socks5 proxy) for 3x-ui

```sh
bash <(curl -sSL https://raw.githubusercontent.com/John777x9/x-ui-scripts/refs/heads/main/install_warp_proxy.sh）
```
